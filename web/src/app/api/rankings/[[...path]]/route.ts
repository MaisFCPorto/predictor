// Proxy público para /api/rankings/** -> Worker
...
function buildTarget(req: NextRequest) {
  // tira o prefixo /api/rankings e encaminha para o Worker
...
async function forward(req: NextRequest) {
  ...
  // copia cabeçalhos do cliente (e força no-store)
  ...
  // devolve status + headers + body tal e qual
